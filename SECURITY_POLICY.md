# Politique de Sécurité PULSAR (ISO 27001)

## 1. Objectif et Périmètre

Cette politique définit les règles de sécurité applicables au projet PULSAR, un système agentique hospitalier souverain. Le périmètre inclut l'orchestrateur, les agents spécialisés, le SAS d'anonymisation et les APIs de suivi qualité.
...
📧 **securite@chu-pulsar.local** (adresse fictive pour l'exemple)
...
Toute contribution au code source de PULSAR doit respecter les règles suivantes :
...
Conformément à l'architecture PULSAR, toute modification des composants suivants nécessite une revue approfondie par le RSSI :
...
*Propriétaire : Équipe RSSI PULSAR*

...
// Traduction francaise de l'interface Hermes Desktop.
// Contributed by William MERI. defineLocale() merges with `en`; only
// translated keys are listed, the rest falls back to English.

; ============================================================
; HERMES CHU - Bootstrap Installer
...
OutFile "output\HERMES-CHU-Setup-2.0.0.exe"
...
Section "HERMES CHU" SecMain
    ...
    ; Raccourci Bureau
    CreateShortCut "$DESKTOP\HERMES CHU.lnk" "powershell.exe" '-ExecutionPolicy Bypass -Command "hermes web"' "" "" SW_SHOWMINIMIZED

    ; Raccourci Menu Demarrer
    CreateDirectory "$SMPROGRAMS\HERMES CHU"
    CreateShortCut "$SMPROGRAMS\HERMES CHU\HERMES CHU.lnk" "powershell.exe" '-ExecutionPolicy Bypass -Command "hermes web"' "" "" SW_SHOWMINIMIZED

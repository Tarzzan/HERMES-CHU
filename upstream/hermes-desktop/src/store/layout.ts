...
const SIDEBAR_PINNED_STORAGE_KEY = 'pulsar.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'pulsar.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'pulsar.desktop.sidebarCronOpen'
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'pulsar.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'pulsar.desktop.sessionOrder'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'pulsar.desktop.workspaceOrder'
const PANES_FLIPPED_STORAGE_KEY = 'pulsar.desktop.panesFlipped'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'pulsar:focus-session-search'

...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/pulsar'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('pulsar:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('pulsar:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])

...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/pulsar'
 ...
 * log inline — the GUI equivalent of the install step `pulsar tools` runs

...
import { getPULSARConfigRecord, type PulsarGateway, savePULSARConfig } from '@/pulsar'
import { useI18n } from '@/i18n'
import { Wrench } from '@/lib/icons'
import { cn } from '@/lib/utils'
import { notify, notifyError } from '@/store/notifications'
import { $activeSessionId } from '@/store/session'
import type { PULSARConfigRecord } from '@/types/pulsar'
...
function getServers(config: PULSARConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await savePULSARConfig(nextConfig)

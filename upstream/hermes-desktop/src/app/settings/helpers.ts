import type { PULSARConfigRecord, ToolsetInfo } from '@/types/pulsar'
...
export function getNested(obj: PULSARConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: PULSARConfigRecord, path: string, value: unknown): PULSARConfigRecord {
...
function personalityOptions(config: PULSARConfigRecord): string[] {

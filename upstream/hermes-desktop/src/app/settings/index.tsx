...
import { getPULSARConfigDefaults, getPULSARConfigRecord, savePULSARConfig } from '@/pulsar'
...
export function SettingsView({ gateway, onClose, onConfigSaved, onMainModelChanged }: SettingsPageProps) {
  ...
  const exportConfig = async () => {
    try {
      const cfg = await getPULSARConfigRecord()
  ...
  const resetConfig = async () => {
    ...
    try {
      await savePULSARConfig(await getPULSARConfigDefaults())
      triggerHaptic('success')
      onConfigSaved?.()
    } catch (err) {

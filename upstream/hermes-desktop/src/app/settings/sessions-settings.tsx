...
import { deleteSession, listSessions, setSessionArchived } from '@/pulsar'
...
// / Program Files), which buried any files PULSAR wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.pulsarDesktop` is
    ...
    const settings = window.pulsarDesktop?.settings

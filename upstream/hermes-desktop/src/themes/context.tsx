...
const SKIN_KEY = 'pulsar-desktop-theme-v2'
const MODE_KEY = 'pulsar-desktop-mode-v1'
...
const PROFILE_SKINS_KEY = 'pulsar-desktop-profile-themes-v1'
const PROFILE_MODES_KEY = 'pulsar-desktop-profile-modes-v1'
// Last active profile, recorded so the boot-time paint can pick that profile's
// theme before the gateway reports which profile actually launched.
const LAST_PROFILE_KEY = 'pulsar-desktop-active-profile-v1'
...
function applyTheme(theme: DesktopTheme, mode: 'light' | 'dark') {
  ...
  root.dataset.pulsarTheme = skinName
  root.dataset.pulsarMode = rendered
  ...
  window.pulsarDesktop?.setTitleBarTheme?.({
  ...
  if (typo.fontUrl && !INJECTED_FONT_URLS.has(typo.fontUrl)) {
    ...
    link.dataset.pulsarThemeFont = 'true'
...
/** Sync the desktop skin with the active PULSAR backend theme on connect. */

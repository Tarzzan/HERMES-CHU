...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingPULSARDesktop: 'Démarrage de PULSAR…'
    },
    errors: {
  ...
  notifications: {
    ...
    updatePULSAR: 'Mettre à jour PULSAR',
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /pulsar.',
  ...
  commandCenter: {
    ...
    pulsarActiveSessions: (version, count) => `PULSAR ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@pulsar:example.org' },
  ...
  install: {
    ...
    settingUpTitle: 'Setting up PULSAR Agent',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.pulsar/config.yaml). PULSAR won’t ask again for commands like this — in this session or any future one.`,

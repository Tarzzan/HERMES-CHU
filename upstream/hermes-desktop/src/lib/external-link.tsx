...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|pulsar):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.pulsarDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.pulsarDesktop?.openExternal?.(href)
  }
}

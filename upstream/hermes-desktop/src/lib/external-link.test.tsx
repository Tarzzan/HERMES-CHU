...
const desktopWindow = window as unknown as { pulsarDesktop?: Window['pulsarDesktop'] }
const initialPULSARDesktop = desktopWindow.pulsarDesktop

function installDesktopBridge(partial: Partial<Window['pulsarDesktop']> = {}) {
  desktopWindow.pulsarDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['pulsarDesktop']
}
...
afterEach(() => {
  ...
  if (initialPULSARDesktop) {
    desktopWindow.pulsarDesktop = initialPULSARDesktop
  } else {
    delete desktopWindow.pulsarDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['pulsarDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['pulsarDesktop']['openExternal'] })

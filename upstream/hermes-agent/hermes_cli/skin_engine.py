...
.. code-block:: yaml
    ...
    branding:
      agent_name: "PULSAR"                  # Titre bannière, affichage statut
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "PULSAR"
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "pulsar-jour": {
        "name": "pulsar-jour",
        "description": "PULSAR Jour — thème clair haute lisibilité, idéal pour les yeux sensibles",
        "colors": {
            "banner_border": "#0369A1",
            "banner_title": "#0C4A6E",
            "banner_accent": "#0284C7",
            "banner_dim": "#475569",
            "banner_text": "#0F172A",
            "ui_accent": "#0284C7",
            "ui_label": "#0369A1",
            ...
            "prompt": "#0C4A6E",
            "input_rule": "#7DD3FC",
            "response_border": "#0369A1",
            "session_label": "#0284C7",
            "session_border": "#94A3B8",
            "status_bar_bg": "#E0F2FE",
            "voice_status_bg": "#E0F2FE",
            "completion_menu_bg": "#F0F9FF",
            "completion_menu_current_bg": "#BAE6FD",
            "completion_menu_meta_bg": "#E0F2FE",
            "completion_menu_meta_current_bg": "#7DD3FC",
        },
        "spinner": {},
        "branding": {
            "agent_name": "PULSAR",
            "welcome": "Bienvenue dans PULSAR ! Tapez votre message ou /help pour les commandes.",
            "goodbye": "Au revoir ! ⚕",
            "response_label": " ⚕ PULSAR ",
            "prompt_symbol": "❯",

...
class CLICommandsMixin:
    ...
    def _handle_update_command(self) -> bool:
        """Handle /update — mettre à jour PULSAR vers la dernière version.
        ...
        if is_managed():
            print(f"  ✗ {format_managed_message('mettre à jour PULSAR')}")
            return False
        ...
        choices = [
            ("once", "Mettre à jour maintenant", "quitter la session et mettre à jour PULSAR"),
            ("cancel", "Cancel", "keep the current session"),
        ]
        raw = self._prompt_text_input_modal(
            title="⚥  Mettre à jour PULSAR",

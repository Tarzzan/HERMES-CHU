...
const TAG_FULL = 'DSIO · CHU de Guyane — une pulsation réveille des agents vigilants'
const TAG_MID = 'Agents médicaux · CHU de Guyane'
const TAG_TINY = 'CHU de Guyane'
const HIDE_BELOW = 34
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · DSIO CHU de Guyane</Text>
          </Text>

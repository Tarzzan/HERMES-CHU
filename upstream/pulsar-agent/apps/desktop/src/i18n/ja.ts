...
export const ja = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'PULSAR Desktop を起動中…'
    },
    errors: {
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `PULSAR ${version} · アクティブセッション ${count}`,
  ...
  onboarding: {
    headerTitle: 'PULSAR のセットアップをしましょう',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `これにより "${pattern}" パターンが永続的な許可リスト (~/.hermes/config.yaml) に追加されます。PULSAR はこのセッションや将来のセッションで、このようなコマンドについて再度尋ねません。`,
      alwaysAllow: '常に許可'
    },
    clarify: {

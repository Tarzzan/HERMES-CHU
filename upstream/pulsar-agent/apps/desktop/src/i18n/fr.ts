...
//
// Traduction française complète de l'interface PULSAR Desktop.
// Bâtie sur `...en` comme filet de sécurité : toute clé non traduite retombe
// proprement sur l'anglais (type-complet). Les termes techniques et noms propres
// (Telegram, Slack, Discord, MCP, OAuth, YOLO, cron, gateway, commandes CLI)
// sont conservés. Les chaînes utilisent des guillemets doubles pour éviter
// l'échappement des apostrophes françaises.
//
...
export const fr: Translations = {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'Le backend du bureau a rejeté cette requête (405 Method Not Allowed). Essayez de redémarrer PULSAR Desktop.',
  ...
  settings: {
    ...
    searchPlaceholder: {
      about: 'À propos de PULSAR Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Choisissez un mode fixe ou laissez PULSAR suivre votre réglage système.',
    ...
    config: {
      ...
      loading: 'Chargement de la configuration PULSAR...',
    ...
    gateway: {
      ...
      intro:
        "PULSAR Desktop démarre son propre gateway local par défaut. Utilisez un gateway distant pour piloter un backend PULSAR déjà en cours d'exécution sur une autre machine ou derrière un proxy de confiance. Choisissez un profil ci-dessous pour lui donner son propre hôte distant.",
      ...
      localDesc: 'Démarre un backend PULSAR privé sur localhost. C\'est la valeur par défaut, fonctionne hors ligne.',
      remoteTitle: 'Gateway distant',
      remoteDesc:
        "Connecte ce shell de bureau à un backend PULSAR distant. Les gateways hébergés utilisent OAuth ou un identifiant et un mot de passe ; les auto-hébergés peuvent utiliser un jeton de session.",
      ...
      restartingMessage: 'PULSAR Desktop se reconnectera avec les paramètres enregistrés.',
      savedMessage: 'Enregistré pour le prochain redémarrage.',
      connectedTo: (baseUrl, version) => `Connecté à ${baseUrl}${version ? ` · PULSAR ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Connectez-vous avec un abonnement — aucune clé API à copier. PULSAR exécute la connexion navigateur pour vous, directement dans l\'application.',
      connected: 'Connecté',
      collapse: 'Réduire',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Paramètres', detail: 'Configurer PULSAR desktop' },
    ...
    hermesActiveSessions: (version, count) => `PULSAR ${version} · Sessions actives ${count}`,
  ...
  profiles: {
    ...
    createDesc: 'Les profils sont des environnements PULSAR indépendants : config, compétences et SOUL.md distincts.',
    nameLabel: 'Nom',
  ...
  cron: {
    ...
    emptyDescNew:
      'Planifiez un prompt à exécuter selon une expression cron. PULSAR l\'exécutera et livrera les résultats à la destination choisie.',
  ...
  composer: {
    ...
    placeholderReconnecting: 'Reconnexion à PULSAR…',
    placeholderFollowUp: 'Envoyer un suivi',
    newSessionPlaceholders: [
      'Que construit-on ?',
      'Donnez une tâche à PULSAR',
      'À quoi pensez-vous ?',
    ...
    attachUrlDesc: 'PULSAR récupérera la page et l\'inclura comme contexte pour ce tour.',
  ...
  updates: {
    ...
    unsupportedMessage: "Cette version de PULSAR ne peut pas se mettre à jour depuis l'application.",
    ...
    availableBody: 'Une nouvelle version de PULSAR est prête à installer.',
    availableTitleBackend: 'Mise à jour du backend disponible',
    availableBodyBackend: 'Une version plus récente du backend PULSAR connecté est prête à installer.',
    ...
    manualBody: 'Vous avez installé PULSAR en ligne de commande, les mises à jour s\'y font donc aussi. Collez ceci dans votre terminal :',
    manualPickedUp: 'PULSAR prendra la nouvelle version au prochain lancement.',
    copy: 'Copier',
    copied: 'Copié',
    done: 'Terminé',
    applyingBody: 'Le programme de mise à jour PULSAR prend le relais dans sa propre fenêtre et rouvre PULSAR une fois terminé.',
    applyingBodyBackend: 'Le backend distant applique la mise à jour et va redémarrer. PULSAR se reconnecte automatiquement à son retour.',
    applyingClose: 'PULSAR va se fermer pour appliquer la mise à jour.',
  ...
  install: {
    ...
    oneTimeTitle: 'PULSAR nécessite une installation unique',
    ...
    settingUpTitle: 'Configuration de PULSAR',
    finishingTitle: 'Finalisation',
    failedDesc:
      "Une des étapes d'installation a échoué. Sous Windows, cela peut arriver si une autre instance CLI ou bureau de PULSAR est en cours. Arrêtez toute instance PULSAR active, puis réessayez. Consultez les détails ci-dessous ou le journal du bureau pour la transcription complète.",
    activeDesc:
      "Il s'agit d'une configuration unique. L'installateur PULSAR télécharge les dépendances et configure votre machine. Les lancements suivants sauteront cette étape.",
  ...
  onboarding: {
    ...en.onboarding,
    headerTitle: 'Configurons PULSAR ensemble',
    headerDesc: 'Connectez un fournisseur de modèle pour commencer à discuter. La plupart des options se font en un clic.',
    preparingInstall: "PULSAR termine son installation. Cela prend généralement moins d'une minute au premier lancement.",
    starting: 'Démarrage de PULSAR…',
    ...
    recommended: 'Recommandé',
    connected: 'Connecté',
    featuredPitch: 'Un abonnement, plus de 300 modèles de pointe — la façon recommandée d\'utiliser PULSAR',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'auto-hébergé',
        description: 'Pointez PULSAR vers un endpoint local ou auto-hébergé compatible OpenAI (vLLM, llama.cpp, Ollama, etc.).',
      },
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Ouvre une page de vérification dans votre navigateur — PULSAR se connecte automatiquement',
      loopback: 'Ouvre votre navigateur pour vous connecter — PULSAR se connecte automatiquement',
    ...
    authorizeThere: 'Autorisez PULSAR là-bas.',
    ...
    autoBrowser: provider =>
      `Nous avons ouvert ${provider} dans votre navigateur. Autorisez PULSAR là-bas et vous serez connecté automatiquement — rien à copier ni coller.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `PULSAR Desktop v${version}`,
      ...
      gatewayTitle: "Statut du gateway d'inférence PULSAR",
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} fait ${size}. PULSAR n'affichera que les 512 premiers Ko.`,
    ...
    web: {
      ...
      tryAgain: 'Réessayer',
      restarting: 'PULSAR redémarre...',
      askRestart: 'Demander à PULSAR de redémarrer le serveur',
      lookingRestart: taskId => `PULSAR cherche un serveur d'aperçu à redémarrer (${taskId})`,
      restartingTitle: "Redémarrage du serveur d'aperçu",
      restartingMessage: "PULSAR travaille en arrière-plan. Suivez la console d'aperçu pour la progression.",
      ...
      finishedRestarting: message => `PULSAR a fini de redémarrer le serveur d'aperçu${message ? ` : ${message}` : ''}`,
      ...
      restartFailedMessage: "PULSAR n'a pas pu redémarrer le serveur.",
      stillWorking:
        "PULSAR travaille toujours, mais aucun résultat de redémarrage n'est encore arrivé. La commande du serveur s'exécute peut-être au premier plan.",
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'PULSAR charge une réponse',
      thinking: 'Réflexion',
    ...
    approval: {
      gatewayDisconnected: "Le gateway PULSAR n'est pas connecté",
      ...
      alwaysDescription: pattern =>
        `Ceci ajoute le motif « ${pattern} » à votre liste d'autorisations permanente (~/.hermes/config.yaml). PULSAR ne redemandera plus pour des commandes de ce type — dans cette session ou toute session future.`,
  ...
  prompts: {
    ...
    sudoDesc: "PULSAR a besoin de votre mot de passe sudo pour exécuter une commande privilégiée. Il n'est envoyé qu'à votre agent local.",
    sudoPlaceholder: 'mot de passe sudo',
    secretTitle: 'Secret requis',
    secretDesc: 'PULSAR a besoin d\'un identifiant pour continuer.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: "Redémarrez PULSAR Desktop pour utiliser « Enregistrer l'image ».",
    restartToSaveImages: 'Redémarrez PULSAR Desktop pour enregistrer les images',

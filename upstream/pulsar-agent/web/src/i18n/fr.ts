...
export const fr: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins PULSAR (parité avec `hermes plugins`).",
  ...
  achievements: {
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'PULSAR détecte un signal lié, la carte passe à Découvert et affiche son exigence.",

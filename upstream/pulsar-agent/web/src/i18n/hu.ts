...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateHermes: "PULSAR frissítése",
    updatingHermes: "PULSAR frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "PULSAR-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `hermes plugins` paritás).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető PULSAR-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "PULSAR munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a PULSARt",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a PULSAR kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A PULSAR egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",

/**
 * HERMES CHU — Traductions françaises complètes
 * Basé sur la structure i18n de hermes-agent (NousResearch)
...
export const fr: Translations = {
  ...
  // ---------------------------------------------------------------------------
  onboarding: {
    headerTitle: 'Connectez HERMES CHU à un modèle d\'IA',
    headerDesc:
      'Choisissez un fournisseur pour commencer. La plupart des options se configurent en un clic.',
    preparingInstall:
      'HERMES CHU finalise l\'installation. Cela prend généralement moins d\'une minute au premier démarrage.',
    starting: 'Démarrage de HERMES CHU…',
    ...
    connected: 'Connecté',
    featuredPitch:
      'Un abonnement, plus de 300 modèles de pointe — la méthode recommandée pour HERMES CHU',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'auto-hébergé',
        description:
          'Connectez HERMES CHU à un endpoint local ou auto-hébergé compatible OpenAI (vLLM, llama.cpp, Ollama, LM Studio…). Recommandé pour les données sensibles non anonymisées.',
      },
    },
    ...
    flowSubtitles: {
      ...
      device_code:
        'Affiche un code à saisir sur la page de vérification — HERMES CHU se connecte automatiquement',
      loopback:
        'Ouvre votre navigateur pour vous connecter — HERMES CHU se connecte automatiquement',
      external:
    ...
    authorizeThere: 'Autorisez HERMES CHU sur cette page.',
    ...
    autoBrowser: (provider) =>
      `Nous avons ouvert ${provider} dans votre navigateur. Autorisez HERMES CHU et vous serez connecté automatiquement — rien à copier ni à coller.`,
    ...
    chatgptDeviceCode: {
      ...
      instructions: [
        ...
        'HERMES CHU se connectera automatiquement une fois le code validé.',
      ],
  ...
  settings: {
    ...
    providers: {
      ...
      types: {
        ...
        'openai-codex': {
          ...
          howToConnect:
            'Cliquez sur "Se connecter" — un code s\'affichera. Rendez-vous sur chatgpt.com/link et saisissez ce code pour autoriser HERMES CHU.',
          subscriptionNote:
        ...
        nous: {
          ...
          description:
            'Accès aux modèles Hermes via le portail NousResearch. Authentification OAuth device_code.',
    ...
    about: {
      title: 'À propos de HERMES CHU',
      version: 'Version',
      basedOn: 'Basé sur Hermes Agent (NousResearch)',
  ...
  chat: {
    ...
    placeholder: 'Posez votre question à HERMES CHU…',
    placeholderAnonymized: 'Posez votre question (données anonymisées avant envoi)…',
    thinking: 'HERMES CHU réfléchit…',
